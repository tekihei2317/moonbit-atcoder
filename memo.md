...
### 14. [016 - Minimum Coins（★3）](https://atcoder.jp/contests/typical90/tasks/typical90_p)

合計9999枚以下でちょうどN円支払う方法がある、とのこと。全探索を工夫するか、判定問題にするか。

A円硬貨の枚数と、B円硬貨の枚数を全探索する。10^4の2乗なのでギリギリ行けるかな。

C円硬貨の枚数は、残額から計算できる。

これ、どうだろう。最悪ケースは(A, B, C) = (1, 2, 3)の場合かな。降順に並べ変えておいたほうが良いかも？

`moon run`だと早かったけど、これってwasmだからなのかな。

時間は大丈夫だったけど、オーバーフローしてる。int64にする必要がありそう。雑にキャストするとなんかめっちゃ遅くなってるな。

WA: [提出 #73641252 - 競プロ典型 90 問](https://atcoder.jp/contests/typical90/submissions/73641252)

オーバーフローしてWAになってるけど早い。

AC: [提出 #73641332 - 競プロ典型 90 問](https://atcoder.jp/contests/typical90/submissions/73641332)

こっちは工夫してもらったけど制限時間ギリギリ。つらい。
